...
<div class="manage-container">
    <h2 class="manage-title">Tambah Admin</h2>
    ...
    <form action="{{ route('admin.manage.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-wrapper">
            <div class="fields-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_hp" class="form-control" placeholder="Masukkan No Handphone" value="{{ old('no_hp') }}">
                </div>
                ...
                <!-- Wilayah -->
                <div class="form-group" id="wilayah-group" style="{{ old('role') == 'admin_wilayah' ? '' : 'display: none;' }}">
                    <label>Wilayah</label>
        ...
        <div class="actions-footer">
            <a href="{{ route('admin.manage.index') }}" class="btn-delete">Hapus Admin</a>
